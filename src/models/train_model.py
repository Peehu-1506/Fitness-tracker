...
for i, f in zip(range(len(possible_feature_sets)), feature_names):
    ...
    selected_train_X = pd.DataFrame(
        imputer.fit_transform(selected_train_X),
        columns=selected_train_X.columns,
        index=selected_train_X.index
    )
    selected_test_X = pd.DataFrame(
        imputer.transform(selected_test_X),
        columns=selected_test_X.columns,
        index=selected_test_X.index
    )
...
# # Train and test using the neural network
# (
#     class_test_y,
#     class_train_y,
#     class_train_prob_y,
#     class_test_prob_y,
# ) = learner.feedforward_neural_network(
#     X_train_imputed, y_train, X_test_imputed, gridsearch=False
# )
